defmodule PairWeb.UserAuthTest do
  use PairWeb.ConnCase, async: true

  alias Pair.Accounts
  alias PairWeb.UserAuth
  import Pair.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, PairWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      PairWeb.Endpoint.subscribe(live_socket_id)
